...
def test_load_sys_config(mock_sys_config, caplog):
    ...
    with patch("builtins.open", mock_open(read_data=mock_data)), \
         patch("json.load", return_value=mock_sys_config), \
         patch("utilities.configs.load", return_value="mocked_nlp_model") as mock_load, \
         patch("os.path.expanduser", return_value="/home/user/Downloads/MERLIN_fallback_test.csv"):
        ...
        assert AppConfig.fallback_csv_path == "\\home\\user\\Downloads\\MERLIN_fallback_test.csv"
